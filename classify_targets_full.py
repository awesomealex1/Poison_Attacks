...
if __name__ == "__main__":
	...
	p.add_argument('--model_path', type=str, help='Path to model to use for attack', default='network/weights/xception_full_c23_trained_from_scratch_03_31_2024_15_54_00_frozen3.p')
