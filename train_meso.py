...
def train_full(network, device, dataset=FFDataset('train', meso=True), name='meso_full_c23_trained_from_scratch', target=None):
...
def train_on_ff(network, device, dataset=FFDataset('train', meso=True), name='meso_full_c23_trained_from_scratch', frozen=False, epochs=8, lr=0.001, batch_size=76, target=None, face=False):
    '''
    Trains the network.
    Args:
...
def eval_network(network, device, batch_size=100, name='meso_full_c23_trained_from_scratch', target=None, fraction_to_eval=1, epoch=0, face=False):
    '''Evaluates the network performance on test set.'''
    print('Evaluating network')
    val_dataset = FFDataset('val', meso=True, face=face)
...
def eval_network_test(network, device, batch_size=100, name='meso_full_c23_trained_from_scratch', target=None, fraction_to_eval=1, face=False):
    '''Evaluates the network performance on test set.'''
    print('Evaluating network')
